...
class FieldPages(Pages):
    ...
    async def show_page(self, page, *, first=False):
        ...
        value ='[Website]( https://raluvy95.github.io/Muffin/ ) | [Support Server]( https://discord.gg/hNWbqQy )'
        self.embed.add_field(name='Muffin - The Discord Bot', value=value, inline=False)
...
class HelpPaginator(Pages):
    ...
    async def from_cog(cls, ctx, cog):
        ...
        # get the commands
        entries = sorted(ctx.bot.get_cog(cog_name), key=lambda c: c.name)
