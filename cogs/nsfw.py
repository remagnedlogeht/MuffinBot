...
**YOU CAN USE IT IN NSFW CHANNEL**"""
    ...
    async def boobs(self, ctx):
        ...
        async with aiohttp.ClientSession() as cs:
            async with cs.get("https://api.imgur.com/3/gallery/r/boob/time/week", headers={'Authorization': 'Client-ID API'}) as r:
                res = await r.json()
    ...
    async def penis(self, ctx):
        ...
        if ctx.channel.is_nsfw() is False:
            return await ctx.send("**This channel has no NSFW...**")
        async with aiohttp.ClientSession() as cs:
            async with cs.get("https://api.imgur.com/3/gallery/r/penis/time/week", headers={'Authorization': 'Client-ID API'}) as r:
                res = await r.json()
                ran = random.randint(1, 40)
                try:
                    for i in res['data'][:ran]:
    ...
    async def hentai(self, ctx):
        ...
        if ctx.channel.is_nsfw() is False:
            return await ctx.send("**This channel has no NSFW...**")
        async with aiohttp.ClientSession() as cs:
            async with cs.get("https://api.imgur.com/3/gallery/r/hentai/time/week", headers={'Authorization': 'Client-ID API'}) as r:
                res = await r.json()
                ran = random.randint(1, 40)
                try:
                    for i in res['data'][:ran]:
    ...
    async def gayporn(self, ctx):
        ...
        if ctx.channel.is_nsfw() is False:
            return await ctx.send("**This channel has no NSFW...**")
        async with aiohttp.ClientSession() as cs:
            async with cs.get("https://api.imgur.com/3/gallery/r/gayporn/time/week", headers={'Authorization': 'Client-ID API'}) as r:
                res = await r.json()
                ran = random.randint(1, 40)
                try:
                    for i in res['data'][:ran]:
    ...
    async def butt(self, ctx):
        ...
        if ctx.channel.is_nsfw() is False:
            return await ctx.send("**This channel has no NSFW...**")
        async with aiohttp.ClientSession() as cs:
            async with cs.get("https://api.imgur.com/3/gallery/r/ass/time/week", headers={'Authorization': 'Client-ID API'}) as r:
                res = await r.json()
                ran = random.randint(1, 40)
                try:
                    for i in res['data'][:ran]:
    ...
    async def traps(self, ctx):
        ...
        if ctx.channel.is_nsfw() is False:
            return await ctx.send("**This channel has no NSFW...**")
        async with aiohttp.ClientSession() as cs:
            async with cs.get("https://api.imgur.com/3/gallery/r/traps/time/week", headers={'Authorization': 'Client-ID API'}) as r:
                res = await r.json()
                ran = random.randint(1, 40)
                try:
                    for i in res['data'][:ran]:
