...
class Images(commands.Cog):
    ...
    async def triggered(self, ctx, member: discord.Member=None):
        ...
        msg = await ctx.send("<a:Loading:465439021514883072> **Loading... Please wait!**")
        async with aiohttp.ClientSession() as session:
            async with session.get(f"https://dankmemer.services/api/trigger?avatar1={member.avatar_url_as(format='jpg', size=512)}", headers={'Authorization':
                                                                                                                                    'API'}) as resp:
                 if resp.status != 200:
                    return await msg.edit(content='**Could not download file... Please try again!**')
                 data = io.BytesIO(await resp.read())
    ...
    async def deepfry(self, ctx, member: discord.Member=None):
        ...
        msg = await ctx.send("<a:Loading:465439021514883072> **Loading... Please wait!**")
        async with aiohttp.ClientSession() as session:
            async with session.get(f"https://dankmemer.services/api/deepfry?avatar1={member.avatar_url_as(format='jpg', size=512)}", headers={'Authorization':
                                                                                                                                    'API'}) as resp:
                 if resp.status != 200:
                    return await msg.edit(content='**Could not download file... Please try again!**')
                 data = io.BytesIO(await resp.read())
    ...
    async def radialblur(self, ctx, member: discord.Member=None):
        ...
        msg = await ctx.send("<a:Loading:465439021514883072> **Loading... Please wait!**")
        async with aiohttp.ClientSession() as session:
            async with session.get(f"https://dankmemer.services/api/radialblur?avatar1={member.avatar_url_as(format='jpg', size=512)}", headers={'Authorization':
                                                                                                                                    'API'}) as resp:
                 if resp.status != 200:
                    return await msg.edit(content='**Could not download file... Please try again!**')
                 data = io.BytesIO(await resp.read())
    ...
    async def communism(self, ctx, member: discord.Member=None):
        ...
        msg = await ctx.send("<a:Loading:465439021514883072> **Loading... Please wait!**")
        async with aiohttp.ClientSession() as session:
            async with session.get(f"https://dankmemer.services/api/communism?avatar1={member.avatar_url_as(format='jpg', size=512)}", headers={'Authorization':
                                                                                                                                    'API'}) as resp:
                 if resp.status != 200:
                    return await msg.edit(content='**Could not download file... Please try again!**')
                 data = io.BytesIO(await resp.read())
    ...
    async def rip(self, ctx, member: discord.Member=None):
        ...
        msg = await ctx.send("<a:Loading:465439021514883072> **Loading... Please wait!**")
        async with aiohttp.ClientSession() as session:
            async with session.get(f"https://dankmemer.services/api/rip?avatar1={member.avatar_url_as(format='jpg', size=512)}", headers={'Authorization':
                                                                                                                                    'API'}) as resp:
                 if resp.status != 200:
                    return await msg.edit(content='**Could not download file... Please try again!**')
                 data = io.BytesIO(await resp.read())
    ...
    async def gay(self, ctx, member: discord.Member=None):
        ...
        msg = await ctx.send("<a:Loading:465439021514883072> **Loading... Please wait!**")
        async with aiohttp.ClientSession() as session:
            async with session.get(f"https://dankmemer.services/api/gay?avatar1={member.avatar_url_as(format='jpg', size=512)}", headers={'Authorization':
                                                                                                                                    'API'}) as resp:
                if resp.status != 200:
                    return await msg.edit(content='**Could not download file... Please try again!**')
                data = io.BytesIO(await resp.read())
