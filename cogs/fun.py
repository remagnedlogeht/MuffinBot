...
class Fun(commands.Cog):
    ...
    async def meme(self, ctx):
        ...
        async with aiohttp.ClientSession() as cs:
            async with cs.get(f"https://api.imgur.com/3/gallery/r/{memes}/time/week", headers={'Authorization': f'Client-ID {APIi}'}) as r:
                res = await r.json()
    ...
    async def owo(self, ctx):
        ...
        owo = "owo"
        async with aiohttp.ClientSession() as cs:
            async with cs.get(f"https://api.imgur.com/3/gallery/r/{owo}/time/week", headers={'Authorization': f'Client-ID {APIi}'}) as r:
                res = await r.json()
